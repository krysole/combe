...
util.extend(CombeJSAstToJSAst.prototype, {
  ...
  processRule: function (ast, inherited, declaration) {
    ...
    if (children[0].type === 'FunctionExpression') {
      newAst.push(Ast('Return', {}, this.unwrapFunction(children[0])));
    } else if (children[0].type === 'ValueLiteral') {
    ...
    } else if (children[0].rangeLiteral) {
      newAst.push(
        Ast('Return', {}, 
