...
var Class = globals.Class = function Class(supertype, classProperties, properties) {
...
Object.extend(Class, {
  ...
  create: function (supertype, classDescriptors, descriptors) {
    ...
    Constructor.subclass = function (classDescriptors, descriptors) {
      return Class.new(Constructor, classDescriptors, descriptors);
    };
