...
var Ast = module.exports = Class.new(Object, {
  ...
  transform: function (visitor) {
    var childrenAttributes = ast.childrenAttributes.map(function (attr) {
      if (Array.isArray(attr)) {
        return attr.map(function (attrElem) {
          if (attrElem instanceof Ast) {
            return attrElem.visit(visitor);
          }
          else {
            return attrElem;
          }
      ...
      else if (attr instanceof Ast) {
        return attr.visit(visitor);
      }
      else {
        return attr;
      }
