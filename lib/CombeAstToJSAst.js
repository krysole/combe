...
var CombeAst_SimplifyPatterns = require('./CombeAst_SimplifyPatterns');
var CombeAst_AnalyseLexicalScoping = require('./CombeAst_AnalyseLexicalScoping');

var CombeAstToJSAst = module.exports = Class.new(Object, {
  
  translate: function (ast) {
    CombeAst_SimplifyPatterns.analyse(ast);
    CombeAst_AnalyseLexicalScoping.analyse(ast);
  ...
  visitTryCatchStatement: function (ast) { // [ tryBlock, catchParameter, catchBlock, finallyBlock ]
    return JSAst.Try(
      ...
      (ast.catchBlock != null
        ? JSAst.Catch(ast.catchParameter, ast.catchBlock.visit(this))
        : null),
      (ast.finallyBlock != null
        ? JSAst.Finally(ast.finallyBlock.visit(this))
        : null)
    );
  },
