...
var CombeJSParser = ((module).exports = (Class).new(JSParser, {}, {
  ...
  primaryExpression: (function () {
    return (this)._memoize("unnamed_ZBs/qX8ns8KoGjsx1SRC7A", (function () {
  ...
  interpolateExpression: (function () {
    return (this)._memoize("unnamed_dIl3vRuPAicuqwnni8zYig", (function () {
      var body;
      return ((function () {
  ...
  interpolateIdentifier: (function () {
    return (this)._memoize("unnamed_XQcYImGDPSdXvZQyx1RQuw", (function () {
      var body;
      return ((function () {
        (this).stringPatternHandler("%");
  ...
  arrayElement: (function () {
    return (this)._memoize("unnamed_9Vj+/TCrHVZBLf/onyJgAg", (function () {
      var body;
  ...
  propertyAssignment: (function () {
    return (this)._memoize("unnamed_gkwzKiQCtm7L9zbQdfVd9w", (function () {
      var name, expr, body;
  ...
  arguments: (function () {
    return (this)._memoize("unnamed_QjSrvYAuKCCZxZVCfzO8Mw", (function () {
      var exprs;
      return ((function () {
        (this).stringPatternHandler("(");
  ...
  expandInterpolateArgument: (function () {
    return (this)._memoize("unnamed_Gl/Hdoc/cN2YwqQg1BGcLQ", (function () {
      var body;
  ...
  interpolateStatements: (function () {
    return (this)._memoize("unnamed_z4R97r9btvquVDYPtXQD7g", (function () {
      var body;
      return ((function () {
        (this).stringPatternHandler("%");
  ...
  astTemplateExpression: (function () {
    return (this)._memoize("unnamed_O3newRtUVdZ8tBZfS3mFXA", (function () {
      var expr, stmts;
      return (this)._choice((function () {
  ...
  interpolationBody: (function () {
    return (this)._memoize("unnamed_Fi77z8IKKK1PAZSAA3cddg", (function () {
      var expr, stmts;
      return (this)._choice((function () {
        (this).stringPatternHandler("(");
