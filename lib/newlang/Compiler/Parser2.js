...
var Parser = module.exports = Class.new(BaseParser, {
  ...
  ifStatement: (function () {
    return this.memoize("aiFTddDoD4/2zA9svfSqzQ", (function () {
  ...
  tryCatchStatement: (function () {
    return this.memoize("1c0SEBVgt831T9EtXHuWJQ", (function () {
  ...
  argumentsList: (function () {
    return this.memoize("XMmViT/KRipSWtHmWtYyTQ", (function () {
      var t, args;
      return (function () {
        this.stringPatternHandler("(");
        this.ignoringNewlines((function () {
  ...
  objectLiteral: (function () {
    return this.memoize("QJnUFH5RxiHzj1pre6jG8w", (function () {
      var proto, decls;
      return (function () {
        this.stringPatternHandler("{");
        this.ignoringNewlines((function () {
  ...
  functionLiteral: (function () {
    return this.memoize("SwjE9875cOc06VhHYECuTw", (function () {
      var pd, body, fb;
      return this._choice((function () {
        pd = this.optParameter();
        this.op("->");
  ...
  parameterList: (function () {
    return this.memoize("11TS1BEJ887+BqbMTfW52A", (function () {
      var t, params;
      return (function () {
        this.stringPatternHandler("(");
        this.ignoringNewlines((function () {
  ...
  t: (function (typename) {
    ...
    while (token.type === "newline") {
      ...
      else if (this.state.allowContinuationLines && (i.column > this.state.column)) {
        token = this.next();
        break;
      }
      else {
  ...
  log: (function (name) {
    ...
    console.log((("Parser2::log() " + this.positionString()) + " - ") + messages.join("; "));
  })
});
