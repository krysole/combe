...
var Pass1 = module.exports = Class.new(Object, {
  ...
  visitIf: function (ast) { // [ condition, consiquent, alternative ]
    ...
    var condition = Ast1.Call(
      Ast1.VariableLookup('__combe.ensureBoolean'),
  ...
  visitWhile: function (ast) { // [ condition, body ]
    ...
    var condition = Ast1.Function([], [], ast.condition.result);
    var body = Ast1.Function([], [], ast.body.result);
    
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.while'),
      [
        condition,
        body
      ]
  ...
  visitDoWhile: function (ast) { // [ body, condition ]
    ...
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.doWhile'),
      [
        body,
        condition
      ]
  ...
  processFunction: function (ast) { // Method or Function
    ...
    if (contractionParameter != null) {
      ...
      var bodySequence = [prologue];
      bodySequence.push(body);
      body = Ast1.Sequence(bodySequence);
    }
  ...
  visitContinue: function (ast) { // [ argument ]
    ...
    var result = Ast1.Call(
      Ast1.VariableLookup('__combe.Continue'),
      [
        argument
      ]
    );
  ...
  visitOr: function (ast) { // [ lhs, rhs ]
    ...
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.or'),
      [ ast.lhs.result, rhs ]
    );
  },
  ...
  visitXor: function (ast) { // [ lhs, rhs ]
    ...
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.xor'),
  ...
  visitAnd: function (ast) { // [ lhs, rhs ]
    ...
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.and'),
      [ ast.lhs.result, rhs ]
    );
  },
  ...
  visitNot: function (ast) { // [ argument ]
    ...
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.not'),
      [ ast.argument.result ]
    );
  },
  ...
  visitOperator: function (ast) { // [ opname, lhs, rhs ]
    ...
    ast.result = Ast1.Call(
      Ast1.PropertyLookup(
        Ast1.VariableLookup('__combe.InfixOperators'),
        ast.opname
      ),
      [ ast.lhs.result, ast.rhs.result ]
    );
  ...
  visitPrefixOperator: function (ast) { // [ opname, argument ]
    ...
    ast.result = Ast1.Call(
      Ast1.PropertyLookup(
        Ast1.VariableLookup('__combe.PrefixOperators'),
        ast.opname
      ),
      [ ast.argument.result ]
    );
  ...
  visitMethodCall: function (ast) { // [ object, name, this, arguments, block ] rvalue
    ...
    if (hasSimpleName && !hasExpansionArgument && thisArg == null) {
      ...
      ast.result = Ast1.Call(
        Ast1.VariableLookup('__combe.methodCall'),
        [
          ast.object.result,
          name,
          thisArg,
  ...
  visitSubscript: function (ast) { // [ object, arguments ] rvalue
    ...
    if (!hasExpansionArgument) {
      ...
      ast.result = Ast1.Call(
        Ast1.PropertyLookup('__combe.methodCall'),
        [
          ast.object.result,
          name,
          Ast1.Null(),
  ...
  visitCall: function (ast) { // [ function, this, arguments, block ] !rvalue
    ...
    if (!hasExpansionArgument && thisArg == null) {
      ...
      ast.result = Ast1.Call(
        Ast1.VariableLookup('__combe.call'),
        [
          ast.function.result,
          thisArg,
          args
  ...
  visitAssociation: function (ast) { // [ key, value ]
    ...
    ast.result = Ast1.MethodCall(
      Ast1.VariableLookup('__combe.Association'),
      'new',
      [
        ast.key.result,
        ast.value.result
  ...
  visitExpansionArgument: function (ast) { // [ argument ]
    ...
    ast.result = Ast1.Call(
      Ast1.VariableLookup('__combe.expansion'),
      [
        ast.argument.result
      ]
    );
