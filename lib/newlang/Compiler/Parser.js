...
var Parser = module.exports = Class.new(TextParser, {
  ...
  tryCatchStatement: (function () {
    return this.memoize("2jPsErmDVAQKZHiuysUosA", (function () {
      ...
      return (function () {
        ...
        this.id("end");
        return TryCatch(tryBlock.body, name, catchBlock.body);
      }).call(this);
    }));
  }),
  ...
  operator: (function () {
    return this.memoize("2HNrb6Em5pzc7l2yEYiJ5w", (function () {
      var text;
      return (function () {
        this._optional(this.ws);
