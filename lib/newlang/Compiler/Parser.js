...
var Parser = module.exports = Class.new(BaseParser, {
  ...
  expression: (function () {
    return this.memoize("r6nK8mIHIFDI9fN2HU7uPA", (function () {
      return this._choice(this.ifExpression, this.tryCatchExpression, this.varExpression, this.returnExpression, this.breakExpression, this.continueExpression, this.throwExpression, this.operatorExpression);
    }));
  }),
