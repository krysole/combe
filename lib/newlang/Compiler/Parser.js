...
var Parser = module.exports = Class.new(BaseParser, {
  parseFile: (function () {
    var parser = this.new();
    return parser.parseFile.apply(parser, arguments);
  }),
  parse: (function () {
    var parser = this.new();
  ...
  file: (function () {
    return this.memoize("kpmQx7pNQ4diPhljOTZwAg", (function () {
      var stmts;
      return (function () {
        ...
        this.eof();
        return Ast.File(Ast.Sequence(stmts));
      }).call(this);
    }));
  }),
  statement: (function () {
    return this.memoize("xI7/nqSHM7Ow+OH4L1hJ6w", (function () {
      return this._choice(this.ifStatement, this.whileStatement, this.doWhileStatement, this.tryCatchStatement, this.functionStatement, this.expression);
    }));
  }),
  expression: (function () {
    return this.memoize("Cj/d1uqaNg+UNvvynHIq8w", (function () {
      return this._choice(this.ifExpression, this.whileExpression, this.doWhileExpression, this.varExpression, this.returnExpression, this.breakExpression, this.continueExpression, this.throwExpression, this.operatorExpression);
    }));
  }),
  ...
  whileStatement: (function () {
    return this.memoize("aW0DK+aYlUku58vgZovwFw", (function () {
      var body, condition;
      return (function () {
  ...
  whileExpression: (function () {
    return this.memoize("Yb/d/+V9uHqxJVdeGVcJ2w", (function () {
      var condition, body;
      return (function () {
        this.id("while");
        condition = this.expression();
  ...
  doWhileStatement: (function () {
    return this.memoize("YEESY5jCBjb8VTPr9lKTJg", (function () {
      var body, condition;
      return (function () {
        body = this.block((function () {
          return this.id("do");
  ...
  doWhileExpression: (function () {
    return this.memoize("/XmzYYhXyYBwn+1zgKiz/g", (function () {
      var body, condition;
      return (function () {
        this.id("do");
        body = this.expression();
  ...
  functionStatement: (function () {
    return this.memoize("Cob+/xG5b1+WrhpraMlCog", (function () {
      var b, name, lval;
      return this._choice((function () {
        ...
        this._predicate((function () {
          return b.rvalue == null;
        }));
        return Ast.Function(name, b.this, b.parameters, b.body);
      }), (function () {
        b = this.functionBlock((function () {
          this.id("method");
          return name = this.propertyName();
        }));
        return Ast.Method(null, name, b.this, b.parameters, b.rvalue, b.body);
      }), (function () {
        b = this.functionBlock((function () {
          this.id("method");
          return lval = this.methodDefLvalue();
        }));
        return Ast.Method(lval.object, lval.name, b.this, b.parameters, b.rvalue, b.body);
      }));
    }));
  }),
  ...
  varExpression: (function () {
    return this.memoize("cX+DDxNXk1UlBBSk0UmM4A", (function () {
      var name, rvalue;
      return (function () {
        this.id("var");
        ...
        return Ast.DeclareVariable(name, rvalue);
      }).call(this);
    }));
  }),
  ...
  breakExpression: (function () {
    return this.memoize("p3E08RlR3mqrUPUKuZxljg", (function () {
      var arg;
      return (function () {
        this.id("break");
        arg = this._optional(this.expression);
        return Ast.Break(arg);
      }).call(this);
    }));
  }),
  continueExpression: (function () {
    return this.memoize("rGSY8Kto9Ma10udDpOxceg", (function () {
      var arg;
      return (function () {
        this.id("continue");
        arg = this._optional(this.expression);
        return Ast.Continue(arg);
      }).call(this);
    }));
  }),
  ...
  block: (function (header) {
    ...
    return (function () {
      ...
      return Ast.Sequence(stmts != null ? stmts : [
        /* elision */
      ]);
    }).call(this);
  }),
  functionBlock: (function (header) {
    ...
    return this._choice((function () {
      ...
      this.op("->");
      body = this.expression();
      result = Ast.Block(p.this, p.parameters, body);
      result.rvalue = p.rvalue;
      return result;
    }), (function () {
      body = this.block((function () {
        header.call(this);
  ...
  assignmentExpression: (function () {
    return this.memoize("p1jv/+iB4Tz0Rt9zUejzjQ", (function () {
      var lvalue, rvalue;
      return this._choice((function () {
  ...
  equalityOperator: (function () {
    return this.memoize("bh+Luipdjsq0QS0BwfuUgQ", (function () {
      var expr, opname, rhs;
      return (function () {
        ...
        return this._choice((function () {
          ...
          return Ast.InfixOperator(opname, expr, rhs);
        }), (function () {
          return expr;
        }));
      }).call(this);
  ...
  comparisonOperator: (function () {
    return this.memoize("dspiWZ8VZOLTqF9OtHsTKA", (function () {
      var expr, opname, rhs;
      return (function () {
  ...
  leftAssocOperator: (function (term, operator) {
    ...
    return (function () {
      ...
      this._repeat((function () {
        ...
        rhs = term.call(this);
        return expr = Ast.InfixOperator(opname, expr, rhs);
      }));
      return expr;
    }).call(this);
  }),
  ...
  secondaryExpressionFragment: (function (expr) {
    ...
    return this._choice((function () {
      this.op(".");
      name = this.propertyName();
      a = this.optArgumentList();
      return Ast.MethodCall(expr, name, a.this, a.arguments, a.block);
    }), (function () {
      this.op("@");
      name = this.propertyName();
      ...
      a = this.argumentList();
      return Ast.Call(expr, a.this, a.arguments, a.block);
    }), (function () {
      a = this.subscriptArguments();
      return Ast.Subscript(expr, a);
    }));
  }),
  optArgumentList: (function () {
    return this.memoize("DK2qelUUALhRLG224mxZVA", (function () {
      var b;
      return this._choice(this.argumentList, (function () {
        b = this.functionBlock((function () {
          return this.id("do");
        }));
        return {
  ...
  argumentList: (function () {
    return this.memoize("YYWfC9dVfH3rsVGldvbXAg", (function () {
      var ta, expr, args, b;
      return (function () {
        ...
        this.ignoringNewlines((function () {
          ...
          args = this.delimited(this.argument, (function () {
            return this.stringPatternHandler(",");
          }));
          this._optional((function () {
            return this.stringPatternHandler(",");
  ...
  subscriptArguments: (function () {
    return this.memoize("jsJathRgIY4bIxRp3qG8Dw", (function () {
      var args;
      return (function () {
        this.stringPatternHandler("[");
        this.ignoringNewlines((function () {
  ...
  argument: (function () {
    return this.memoize("IbX3u+vjxDzxmMZ+LgJdJg", (function () {
      return this._choice(this.expansionArgument, this.expression);
    }));
  }),
  ...
  primaryExpression: (function () {
    return this.memoize("MxjbCpZnH0EdEUeB+Rg2QQ", (function () {
      return this._choice(this.psuedoVariable, this.variableLookup, this.stringLiteral, this.numberLiteral, this.functionLiteral, this.subexpression);
    }));
  }),
  ...
  functionLiteral: (function () {
    return this.memoize("7nDfRai3Uk0hw8shvusR1A", (function () {
      var p, body, fb;
      return this._choice((function () {
        p = this.optParameterList();
        this.op("->");
        body = this.expression();
        this._predicate((function () {
          return p.rvalue == null;
        }));
        return Ast.Block(p.this, p.parameters, body);
      }), (function () {
        ...
        return Ast.Block(fb.this, fb.parameters, fb.body);
      }), (function () {
        fb = this.functionBlock((function () {
          return this.id("def");
        }));
        ...
        return Ast.Function(null, fb.this, fb.parameters, fb.body);
      }), (function () {
        fb = this.functionBlock((function () {
          return this.id("method");
        }));
        return Ast.Method(null, null, fb.this, fb.parameters, fb.rvalue, fb.body);
      }));
    }));
  }),
  ...
  optParameterList: (function () {
    return this.memoize("tTfnS1P+mnweuGzbNOtMtQ", (function () {
      var rp;
  ...
  parameterList: (function () {
    return this.memoize("pURGNEethGAkVeCJP7VYGw", (function () {
      var tp, p, ps, rp;
      return (function () {
        this.stringPatternHandler("(");
        this.ignoringNewlines((function () {
          tp = this._optional((function () {
            p = this.simpleParameter();
            this.stringPatternHandler(";");
            return p;
          }));
          ps = this.delimited(this.parameter, (function () {
            return this.stringPatternHandler(",");
          }));
          this._optional((function () {
            return this.stringPatternHandler(",");
  ...
  parameter: (function () {
    return this.memoize("NdtBnzsVo0JFj3zmCGI5HQ", (function () {
      return this._choice(this.contractionParameter, this.simpleParameter);
    }));
  }),
