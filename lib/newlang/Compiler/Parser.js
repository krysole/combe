...
var Parser = module.exports = Class.new(BaseParser, {
  ...
  statement: (function () {
    return this.memoize("L0wnv8Z44iFmmqSz1ezv6w", (function () {
      return this._choice(this.ifStatement, this.whileStatement, this.doWhileStatement, this.tryCatchStatement, this.defStatement, this.functionStatement, this.expression);
    }));
  }),
  expression: (function () {
    return this.memoize("xAm1c4S/q9SplOH9jvL2UA", (function () {
      return this._choice(this.ifExpression, this.whileExpression, this.doWhileExpression, this.tryCatchExpression, this.varExpression, this.returnExpression, this.breakExpression, this.continueExpression, this.throwExpression, this.operatorExpression);
    }));
  }),
  ...
  whileExpression: (function () {
    return this.memoize("mVmDBc/+IH959m7k8Chdew", (function () {
      var condition, body;
      return (function () {
        this.id("while");
        condition = this.expression();
  ...
  functionBlock: (function (header) {
    ...
    return this._choice((function () {
      ...
      this.op("->");
      body = this.expression();
      result = Ast.Function(null, p.this, p.parameters, body);
      ...
      this.id("end");
      result = Ast.Function(null, p.this, p.parameter, body);
      result.rvalue = p.rvalue;
      return result;
    }));
  }),
  ...
  optArgumentList: (function () {
    return this.memoize("ioF0kAskvIQZNAyxOwna2Q", (function () {
  ...
  subscriptArguments: (function () {
    return this.memoize("4lTIMA8B53U8ACnsZVVwwA", (function () {
      var args;
      return (function () {
        this.stringPatternHandler("[");
        this.ignoringNewlines((function () {
          args = this.delimited(this.mainArgument, (function () {
            return this.stringPatternHandler(",");
          }));
          this._optional((function () {
            return this.stringPatternHandler(",");
  ...
  optParameterList: (function () {
    return this.memoize("goDCfIWvxV+fGK7JnWdrMw", (function () {
