...
var Parser = module.exports = Class.new(BaseParser, {
  ...
  assignmentExpression: (function () {
    return this.memoize("rVrBoQ0N0ZFk9Tk7C2mvug", (function () {
      var lvalue, rvalue;
      return this._choice((function () {
        ...
        return (function () {
          if (lvalue.is("VariableLookup")) {
            ...
            return Ast.MethodCallAssignment(lvalue.object, lvalue.name + "=", lvalue.thisArgument, lvalue.arguments, rvalue);
          }
          else if (lvalue.is("Subscript")) {
            return Ast.SubscriptAssignemnt(lvalue.object, lvalue.arguments, rvalue);
          }
          else assert(false);
        }).call(this);
  ...
  secondaryExpressionFragment: (function (expr) {
    ...
    return this._choice((function () {
      ...
      this.op(".");
      name = this.propertyName();
      return Ast.MethodCall(expr, name, null, [
        /* elision */
      ]);
    }), (function () {
      ad = this.argumentsList();
