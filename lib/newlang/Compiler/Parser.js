...
var Parser = module.exports = Class.new(TextParser, {
  ...
  tryCatchStatement: (function () {
    return this.memoize("IGZiA+aJYHrqZLL+PZ7bCA", (function () {
      var tryBlock, catchBlock, name;
      return (function () {
        tryBlock = this.specialBlock((function () {
          return this.id("try");
        }));
        catchBlock = this.specialBlock((function () {
          this.id("catch");
          return name = this.variableIdentifier();
        }));
        this.id("end");
        return Ast.TryCatch(tryBlock.body, name, catchBlock.body);
      }).call(this);
    }));
  }),
  ...
  operator: (function () {
    return this.memoize("lLsIH6G2R5fFaLzzJcGnBA", (function () {
      var text;
      return (function () {
        this._optional(this.ws);
