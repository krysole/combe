...
var BaseParser = module.exports = Class.new(Object, {
  ...
  _applyString: function (what) {
    var fn = this._typeParsers['String'];
    if (fn) {
      return fn.call(this, what);
    } else {
      return this._typeParsers.default.apply(this, arguments);
    }
  },
  
  _applyNumber: function (what) {
    var fn = this._typeParsers['Number'];
    if (fn) {
      return fn.call(this, what);
    } else {
      return this._typeParsers.default.apply(this, arguments);
  ...
  _applyBoolean: function (what) {
    var fn = this._typeParsers['Boolean'];
    if (fn) {
      return fn.call(this, what);
    } else {
      return this._typeParsers.default.apply(this, arguments);
  ...
  _applyRange: function (what) {
    var fn = this._typeParsers['Range'];
    if (fn) {
      return fn.call(this, what);
    } else {
      return this._typeParsers.default.apply(this, arguments);
  ...
  _applyObject: function (what) {
    var fn = this._typeParsers['Object'];
    if (fn) {
      return fn.call(this, what);
    } else {
      return this._typeParsers.default.apply(this, arguments);
