...
var JSLexer = ((module).exports = (Class).new(TextParser, {
  ...
  nextToken: (function () {
    return (this)._memoize("unnamed0_vvJ7rKyz", (function () {
      return ((function () {
  ...
  sourceChar: (function () {
    return (this)._memoize("unnamed1_vvJ7rKyz", (function () {
  ...
  identifierName: (function () {
    return (this)._memoize("unnamed2_vvJ7rKyz", (function () {
      var text;
      return ((function () {
  ...
  assignmentOperator: (function () {
    return (this)._memoize("unnamed6_vvJ7rKyz", (function () {
      var text, t;
      return ((function () {
        (text = (this)._choice((function () {
          (this).stringPatternHandler("=");
  ...
  division: (function () {
    return (this)._memoize("unnamed7_vvJ7rKyz", (function () {
      var text;
      return ((function () {
        (text = (this)._choice((function () {
          return (this).stringPatternHandler("/=");
  ...
  number: (function () {
    return (this)._memoize("unnamed8_vvJ7rKyz", (function () {
      return (this)._choice((this).decimal, (this).hexInteger);
    }));
  }),
  decimal: (function () {
    return (this)._memoize("unnamed9_vvJ7rKyz", (function () {
      var text;
      return ((function () {
        (text = ((this).matchedInput).call(this, (function () {
          return (this)._choice((function () {
  ...
  integerPart: (function () {
    return (this)._memoize("unnamed10_vvJ7rKyz", (function () {
      return (this)._choice((function () {
  ...
  exponentPart: (function () {
    return (this)._memoize("unnamed11_vvJ7rKyz", (function () {
      return ((function () {
  ...
  digit: (function () {
    return (this)._memoize("unnamed12_vvJ7rKyz", (function () {
      return ((this).char).call(this, (Range).inclusive("0", "9"));
    }));
  }),
  hexInteger: (function () {
    return (this)._memoize("unnamed13_vvJ7rKyz", (function () {
      var text;
      return ((function () {
        (this)._choice((function () {
  ...
  hexDigit: (function () {
    return (this)._memoize("unnamed14_vvJ7rKyz", (function () {
      return ((this).char).call(this, (Range).inclusive("0", "9"), (Range).inclusive("a", "f"), (Range).inclusive("A", "F"));
    }));
  }),
  string: (function () {
    return (this)._memoize("unnamed15_vvJ7rKyz", (function () {
      var text;
      return ((function () {
        (text = (this)._choice((function () {
  ...
  stringChar: (function () {
    return (this)._memoize("unnamed16_vvJ7rKyz", (function () {
      return (this)._choice((function () {
        (this).stringPatternHandler("\\");
  ...
  stringEscapeSequence: (function () {
    return (this)._memoize("unnamed17_vvJ7rKyz", (function () {
      var hs;
      return (this)._choice((function () {
        (this).stringPatternHandler("'");
        return "'";
  ...
  regex: (function () {
    return (this)._memoize("unnamed18_vvJ7rKyz", (function () {
      var pattern, options;
      return ((function () {
        (this).stringPatternHandler("/");
  ...
  regexChar: (function () {
    return (this)._memoize("unnamed19_vvJ7rKyz", (function () {
      return (this)._choice((function () {
        (this).stringPatternHandler("\\");
        (this)._not((this).newline);
        return ((this).sourceChar).call(this);
  ...
  regexCharacterClass: (function () {
    return (this)._memoize("unnamed20_vvJ7rKyz", (function () {
      return ((function () {
        (this).stringPatternHandler("[");
  ...
  regexCharacterClassChar: (function () {
    return (this)._memoize("unnamed21_vvJ7rKyz", (function () {
      return (this)._choice((function () {
        (this).stringPatternHandler("\\");
        (this)._not((this).newline);
        return ((this).sourceChar).call(this);
  ...
  whitespace: (function () {
    return (this)._memoize("unnamed22_vvJ7rKyz", (function () {
  ...
  spaces: (function () {
    return (this)._memoize("unnamed23_vvJ7rKyz", (function () {
      return ((function () {
  ...
  newline: (function () {
    return (this)._memoize("unnamed24_vvJ7rKyz", (function () {
      return ((function () {
        (this)._choice((function () {
          return (this).stringPatternHandler("\r\n");
        }), (function () {
  ...
  comment: (function () {
    return (this)._memoize("unnamed25_vvJ7rKyz", (function () {
      return ((function () {
        (this)._choice((function () {
          (this).stringPatternHandler("//");
