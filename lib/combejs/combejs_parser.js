...
util.extend((CombeJSParser.prototype = Object.create(ParentParser.prototype)), {
...
(function () {return this.stringTokenOperatorHandler('}');}),
(function () {return ( Ast('Match', {}, ptn, ptn)
  );}));}));
},
...
(function () {return (pdefs = this._apply((function () {return this._apply(this.delimited, this.propertyAssignment, (function () {return this.stringTokenOperatorHandler(',');}));})));}),
(function () {return this.stringTokenOperatorHandler('}');}),
(function () {return ( Ast('Class', {name: (name ? name.value : null)}, inherits).concat(pdefs)
  );}));}));
},
...
(function () {return (expr = this._apply(this.expression));}),
(function () {return ( Ast('ConcatPattern', {}, ptn, Ast('ActionPattern', {}, expr))
      );}));}),
(function () {return ( ptn
      );}));}));}),
(function () {return this._concat((function () {return this.stringTokenOperatorHandler('->');}),
(function () {return (expr = this._apply(this.expression));}),
(function () {return ( Ast('ActionPattern', {}, expr)
  );}));}));}));
},
...
(function () {return this._concat((function () {return this.stringTokenOperatorHandler('#');}),
(function () {return (ptn = this._apply(this.prefixOperatorPattern));}),
(function () {return ( Ast('HashPattern', {}, ptn)
  );}));}));}));
},
...
(function () {return this._concat((function () {return (args = this._apply(this.patternArguments));}),
...
(function () {return ( Ast('LiteralPattern', {}, expr)
  );}));}));
},
