...
extend((CombeASTTranslator.prototype = Object.create(ParentParser.prototype)), {
...
transform: function () {
var name, parent, rules, jsCode, args, vars, expr, exprs, jsExpr, string, argExprs, leftExpr, rightExpr, number;
