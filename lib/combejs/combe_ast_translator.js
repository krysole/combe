...
(function () {return ( [(name.isReservedWord() ? name.quote() : name), 
...
(function () {return (jsExpr = this._apply(this.recur));}),
(function () {return ( ['(function () {return this._predicate(', jsExpr, ');})']
...
(function () {return ( ['(Range.inclusive(', leftExpr, ', ', rightExpr, '))']
