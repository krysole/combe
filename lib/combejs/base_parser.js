...
// Make sure the class and range globals are initialized (not referring to the locals here)
...
extend(BaseParser.prototype, {
  ...
  // Todo: Change this in the new syntax to be 
  // _repeat: function (parser, range)
  // where range may either be the number of times it should appear, or
  // a range object.
  ...
  _delimited1: function (elementParser, delimiterParser, max /* = null */) {
    return this._delimited(elementParser, delimiterParser, 1, max);
  },
