...
extend((CombeASTIdempotent.prototype = Object.create(ParentParser.prototype)), {
...
transform: function () {
var name, parent, rules, args, vars, expr, jsCode, exprs, jsExpr, string, argExprs, leftExpr, rightExpr, number;
