...
(function () {return this._concat((function () {return this._concat('Choice', (function () {exprs = this._apply((function () {return this._repeat1(this.recur);}));}));}), (function () {return ( ['Choice'].concat(exprs)
    
    );}));}),
(function () {return this._concat((function () {return this._concat('Concat', (function () {exprs = this._apply((function () {return this._repeat1(this.recur);}));}));}), (function () {return ( ['Concat'].concat(exprs)
