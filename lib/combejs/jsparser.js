...
var JSParser = module.exports = Class.new(ParentParser, {
...
var token;
return this._apply((function () {return this._concat((function () {return (token = this._apply((function () {return this._choice((function () {return this.identifierTokenOperatorHandler("null");}),
...
(function () {return ( Ast('DotPropertyLookup', {name: t.value}, subject)
  );}));}));}));
},
...
(function () {return this.stringTokenOperatorHandler(')');}),
(function () {return (stmt = this._apply(this.statement));}),
(function () {return ( Ast('ForIn', {}, vardecl, subject, stmt)
  );}));}));}));
},
