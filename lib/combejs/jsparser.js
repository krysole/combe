...
(function () {return (exprs = this._apply((function () {return this._apply(this.delimited, (function () {return this._optional(this.assignmentExpression);}), (function () {return this.stringTokenOperatorHandler(',');}));})));}),
(function () {return this.stringTokenOperatorHandler(']');}),
...
var token;
return this._apply((function () {return this._concat((function () {return (token = this._apply((function () {return this._choice((function () {return this.identifierTokenOperatorHandler("identifierName");}),
(function () {return this.identifierTokenOperatorHandler("string");}),
(function () {return this.identifierTokenOperatorHandler("number");}));})));}),
(function () {return ( token.name
  );}));}));
},
...
(function () {
        if (op.type === '=') {
          ...
          return Ast('OperatorAssignment', {operator: type.slice(0, -1)}, lhs, rhs);
        }
      }));}),
...
(function () {return this.stringTokenOperatorHandler(';');}),
(function () {return ( Ast('VariableStatement').concat(lst)
  );}));}));
},
...
(function () {return this.stringTokenOperatorHandler(')');}),
(function () {return (stmt = this._apply(this.statement));}),
(function () {return ( Ast('ForIn', {declareVariable: vardecl.name}, vardecl.at(0), subject, stmt)
  );}));}));}));
},
