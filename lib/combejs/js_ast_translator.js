...
util.extend(JSAstTranslator.prototype, {
  ...
  translateArrayLiteral: function (ast) {
    ...
    var elements = this.indented(function () {
  ...
  translateFor: function (ast) {
    ...
    return [this.indentation(), 'for (', initExpr, ';', condExpr, ';', incExpr, ') ', blk];
  },
  ...
  translateForIn: function (ast) {
    ...
    var blk = this.translateBlock(ast.children[2], true);
    return [this.indentation(), 'for (', lvalue, ' in ', subject, ') ', blk];
  },
