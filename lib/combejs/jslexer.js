...
var ParentParser = (TextParser);

var JSLexer = module.exports = Class.new(ParentParser, {
...
nextToken: function () {
return this._apply((function () {return this._concat((function () {return this._optional(this.whitespace);}),
...
(function () {return this._concat(this.eof,
(function () {return this._apply(this.token, 'eof');}));}),
(function () {throw new Error('Not a valid token');}));}));}));
},
...
var t;
return this._apply((function () {return this._concat((function () {return (t = this._apply((function () {return this._apply(this.token, type, tags, value);})));}),
(function () {return (t.identifierName = name);}),
(function () {return ( t
  );}));}));
},
...
(function () {return this._concat((function () {return this._predicate((function () {return (['get', 'set'].include(text));}));}),
...
return this._apply((function () {return this._apply(this.char, (Range.inclusive('a', 'z')), (Range.inclusive('A', 'Z')), '_', '$');}));
},

idChar: function () {
return this._apply((function () {return this._apply(this.char, (Range.inclusive('a', 'z')), (Range.inclusive('A', 'Z')), '_', '$', (Range.inclusive('0', '9')));}));
},
...
integer: function () {
return this._apply((function () {return this._concat((function () {return this._apply(this.char, (Range.inclusive('1', '9')));}),
(function () {return this._repeat(this.digit);}));}));
},

digit: function () {
return this._apply((function () {return this._apply(this.char, (Range.inclusive('0', '9')));}));
},
...
hexDigit: function () {
return this._apply((function () {return this._apply(this.char, (Range.inclusive('0', '9')), (Range.inclusive('a', 'f')), (Range.inclusive('A', 'F')));}));
},
...
whitespace: function () {
return this._apply((function () {return this._repeat1((function () {return this._choice(this.spaces,
this.newline,
this.comment);}));}));
},

spaces: function () {
return this._apply((function () {return this._concat((function () {return this._repeat1((function () {return this._apply(this.char, ' \t\v\f\u00a0\u200c\u200d\ufeff');}));}),
