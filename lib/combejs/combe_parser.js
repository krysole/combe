...
util.extend((CombeParser.prototype = Object.create(ParentParser.prototype)), {

combeFile: function () {
var h, g;
return this._apply((function () {return this._choice((function () {return this._concat((function () {return (h = this._apply(this.header));}),
(function () {return (g = this._apply(this.grammar));}),
(function () {return ( ['CombeFile', h, g]
    );}));}),
(function () {return this._concat((function () {return (g = this._apply(this.grammar));}),
(function () {return ( ['CombeFile', g]
  );}));}));}));
},

header: function () {
var code;
return this._apply((function () {return this._concat((function () {return this.stringTokenOperatorHandler('header');}),
(function () {return this.stringTokenOperatorHandler('{');}),
(function () {return (code = this._apply((function () {return this._apply(this.jsUntil, '}');})));}),
'}',
(function () {return ( ['Header', code]
  );}));}));
},
...
letter: function () {
return this._apply((function () {return this._choice((Range.inclusive('a', 'z')),
(Range.inclusive('A', 'Z')));}));
},

digit: function () {
return this._apply((Range.inclusive('0', '9')));
},
