...
grammar: function () {
var name, rules;
return this._apply((function () {return this._concat((function () {return this.token('combe');}),
(function () {return (name = this._apply((function () {return this.token(this.identifier);})));}),
(function () {return this.token('{');}),
(function () {return (rules = this._apply((function () {return this._repeat(this.rule);})));}),
(function () {return this.token('}');}),
(function () {return this.token(this.eof);}),
...
rule: function () {
var name, args, e;
return this._apply((function () {return this._concat((function () {return this.token('rule');}),
...
var args;
return this._apply((function () {return this._choice((function () {return this._concat((function () {return this.token('[');}),
(function () {return (args = this._apply((function () {return this._apply(this.delimited, this.ruleArgument, (function () {return this.token(',');}));})));}),
(function () {return this.token(']');}),
...
var name;
return this._apply((function () {return this._concat((function () {return (name = this._apply((function () {return this.token(this.identifier);})));}),
...
choice: function () {
var e, es;
return this._apply((function () {return this._concat((function () {return this._optional((function () {return this.token('|');}));}),
(function () {return (e = this._apply(this.returnOperator));}),
(function () {return this._choice((function () {return this._concat((function () {return (es = this._apply((function () {return this._repeat1((function () {return this._concat((function () {return this.token('|');}),
this.returnOperator);}));})));}),
...
(function () {return this._choice((function () {return this._concat((function () {return this.token('->');}),
(function () {return (a = this._apply(this.returnOperatorArgument));}),
(function () {return ( ['Concat', e, a]
      );}));}),
(function () {return ( e
      );}));}));}),
(function () {return this._concat((function () {return this.token('->');}),
...
(function () {return (name = this._apply(this.identifier));}),
(function () {return (this.locals.push(name));}),
(function () {return ( ['Bind', name, ['Apply', 'anything']]
  );}));}));}));
},
...
repeat: function () {
var e;
return this._apply((function () {return this._concat((function () {return (e = this._apply(this.combeToken));}),
(function () {return this._choice((function () {return this._concat((function () {return this.token('*');}),
...
var e;
return this._apply((function () {return this._choice((function () {return this._concat((function () {return this.token('$');}),
(function () {return (e = this._apply(this.term));}),
(function () {return ( ['Token', e]
    );}));}),
this.term);}));
},
...
'[',
(function () {return (args = this._apply((function () {return this._apply(this.delimited, this.gexpr, (function () {return this.token(',');}));})));}),
(function () {return this.token(']');}),
...
var e;
return this._apply((function () {return this._concat((function () {return this.token('[');}),
(function () {return (e = this._apply(this.gexpr));}),
(function () {return this.token(']');}),
...
literal: function () {
var s, n;
return this._apply((function () {return this._choice((function () {return this._concat((function () {return (s = this._apply((function () {return this.token(this.string);})));}),
(function () {return ( ['String', s]
    );}));}),
(function () {return this._concat((function () {return (n = this._apply((function () {return this.token(this.number);})));}),
...
var code;
return this._apply((function () {return this._concat((function () {return this.token(prefix);}),
'{',
