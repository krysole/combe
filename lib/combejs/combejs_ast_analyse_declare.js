...
var CombeJSAstAnalyseDeclare = module.exports = function CombeJSAstAnalyseDeclare() {
  var self = Object.create(CombeJSAstAnalyseDeclare.prototype);
  return self;
};

util.extend(CombeJSAstAnalyseDeclare.prototype, {
  ...
  visitSetPropertyDeclaration: function (ast, inherited) {
    var synthesized = this.visitAll(ast.children, {});
    ast.declare = this.collectDeclare(synthesized).push(ast.name).withoutDuplicates();
    return {declare: []};
  },
  ...
  visitForIn: function (ast, inherited) {
    var synthesized = this.visitAll(ast.children, {});
    var declare = this.collectDeclare(synthesized);
    if (ast.declareVariable) declare.push(ast.declareVariable);
    declare = declare.withoutDuplicates();
    return {declare: declare};
  },
  
  visitCatch: function (ast, inherited) {
    var synthesized = this.visitAll(ast.children, {});
    ast.declare = [ast.name].concat(this.collectDeclare(synthesized)).withoutDuplicates();
    return {declare: []};
  },
  ...
  visitRuleExpression: function (ast, inherited) {
    var synattrs = this.visit(this.children[0], {});
  ...
  visitBindPattern: function (ast, inherited) {
    var synattrs = this.visit(this.children[0], {});
    return {declare: [ast.name].concat(synattrs.declare).withoutDuplicates()};
  },
  ...
  collectDeclare: function (array) {
    ...
    return declare.withoutDuplicates();
  },
