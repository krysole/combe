  ...
  var CombeJSParser = (__combejs__Class).create(JSParser, {
          ...
          return (this)._concat((function () {
            ...
            return (this)._choice((function () {
              return (this)._concat((function () {
                ...
                return (((Ast)("ChoicePattern", {}, ptn)).concat)(ptns);
              }));
            }), (function () {
              return ptn;
            }));
    ...
    concatPattern: {
      value: (function () {
        ...
        return (this)._apply((function () {
          return (this)._concat((function () {
            return (ptn = (this)._apply((this).bindPattern));
          }), (function () {
            return (this)._choice((function () {
              return (this)._concat((function () {
                return (ptns = (this)._apply((function () {
                  return (this)._repeat1((this).bindPattern);
                })));
              }), (function () {
    ...
    prefixOperatorPattern: {
      value: (function () {
        var ptn;
        return (this)._apply((function () {
          return (this)._choice((this).repeatPattern, (function () {
            return (this)._concat((function () {
              return (this)._concat("~", (function () {
                return (ptn = (this)._apply((this).prefixOperatorPattern));
              }));
          ...
          return (this)._choice((function () {
            ...
            return (this)._concat((function () {
              return (this)._concat("?", (function () {
                ...
                return (stmts = (this)._apply((function () {
                  return (this)._repeat((this).statements);
                })));
              }), "}");
            }), (function () {
          ...
          return (this)._choice((function () {
            ...
            return (this)._concat((function () {
              return (this)._concat("!", (function () {
                ...
                return (stmts = (this)._apply((function () {
                  return (this)._repeat((this).statments);
                })));
              }), "}");
            }), (function () {
              return (((Ast)("ActionBlockPattern")).concat)(stmts);
