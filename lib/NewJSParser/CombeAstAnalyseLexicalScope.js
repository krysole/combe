...
var CombeAstAnalyseLexicalScope = module.exports = Class.new(Object, {
  ...
  visitFunction: function (ast) {
    ...
    ast.lexicalScope.pushAll(ast.argumentNames);
    this.allSetLexicalScope(ast.statements, ast.lexicalScope);
    this.visitAll(ast.statements);
  },
  ...
  visitVariableDeclaration: function (ast) {
    ast.variables.pushIfAbsent(ast.name);
  ...
  visitDoWhile: function (ast) {
    ast.body.lexicalScope = lexicalScope;
    this.visit(ast.body);
    ast.condition.lexicalScope = lexicalScope;
    this.visit(ast.condition);
  },
  ...
  visitFor: function (ast) {
    ast.initialize.lexicalScope = lexicalScope;
    this.visit(ast.initialize);
    ast.condition.lexicalScope = lexicalScope;
    this.visit(ast.condition);
    ast.increment.lexicalScope = lexicalScope;
  ...
  visitForIn: function (ast) {
    ast.lvalue.lexicalScope = lexicalScope;
    this.visit(lvalue);
    ast.rvalue.lexicalScope = lexicalScope;
    this.visit(rvalue);
    ast.body.lexicalScope = lexicalScope;
    this.visit(body);
  },
  ...
  visitReturn: function (ast) {
    if (ast.expression) {
      ast.expression.lexicalScope = lexicalScope;
      this.visit(ast.expression);
    }
  },
  
  visitWith: function (ast) {
    ast.subject.lexicalScope = lexicalScope;
