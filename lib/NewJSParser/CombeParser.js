...
var CombeParser = ((module).exports = (Class).new(JSParser, {
  ...
  expandInterpolateFunctionArgument: (function () {
    return (this).memoize("unnamed_W7XNmvDkdpx3Wwxot0FlwA", (function () {
      var body;
      return (this)._choice((function () {
        (this).stringPatternHandler("%");
        (this).stringPatternHandler("expand");
  ...
  identifier: (function () {
    return (this).memoize("unnamed_3mXM1zsU4A8/eozCZnqndw", (function () {
      var body;
  ...
  identifierName: (function () {
    return (this).memoize("unnamed_i64eBfi9/lsTljbkf0gsyw", (function () {
      var body;
  ...
  ruleExpression: (function () {
    return (this).memoize("unnamed_KmYOEJ71IVLgbIekaLC0OQ", (function () {
      var name, args, ptn;
      return ((function () {
  ...
  variablePattern: (function () {
    return (this).memoize("unnamed_5kLKpufcRn8pnSNvwMyXAw", (function () {
      var name;
      return ((function () {
