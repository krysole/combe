...
var CombeParser = ((module).exports = (Class).new(JSParser, {
  ...
  returnPattern: (function () {
    return (this).memoize("unnamed_3zw/T3eBoBIiCQUEaXXk6w", (function () {
      var ptn, expr, stmts;
      return (this)._choice((function () {
        ...
        return (this)._choice((function () {
          ...
          return (Ast).ConcatPatttern([
            ptn,
            (Ast).Action((Ast).ExpressionBody(expr))
          ]);
        }), (function () {
          (this).stringPatternHandler("->");
          (this).stringPatternHandler("{");
          ...
          return (Ast).ConcatPattern([
            ptn,
            (Ast).Action((Ast).StatementsBody(stmts))
          ]);
        }), (function () {
          return ptn;
        }));
        ...
        (this).stringPatternHandler("->");
        (expr = ((this).leftHandSideExpression).call(this));
        return (Ast).Action((Ast).ExpressionBody(expr));
      }), (function () {
        (this).stringPatternHandler("->");
        (this).stringPatternHandler("{");
        (stmts = (this)._repeat((this).statement));
        (this).stringPatternHandler("}");
        return (Ast).Action((Ast).StatementsBody(stmts));
      }));
    }));
  }),
