...
var JSAstToJS = module.exports = Class.new(Object, {
  ...
  visitNew: function (ast) {
    return ['new ', this.subexpr(ast.receiver), this.processArguments(ast.arguments)];
  },
  ...
  visitSequence: function (ast) {
    // Todo: Make sure that this works ok with only one expression (I may
    // also have to check the other analyses)
