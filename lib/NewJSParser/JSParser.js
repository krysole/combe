...
var JSParser = ((module).exports = (Class).new(TokenParser, {
  ...
  valueLiteral: (function () {
    return (this).memoize("unnamed_me+Z3ZCVGjRfOB0B9IFAvQ", (function () {
      var v, n, s, r;
      return ((function () {
  ...
  callExpression: (function () {
    return (this).memoize("unnamed_T6x7gLGc5jbcPU/zO5B4BQ", (function () {
      var expr, args;
      return ((function () {
        ...
        (this)._choice((function () {
          ...
          return (expr = (JSAst).CallMethod((expr).receiver, (expr).name, arguments));
        }), (function () {
  ...
  variableDeclaration: (function (noIn) {
    ...
    return ((function () {
      ...
      return (this)._choice((function () {
        ...
        return (JSAst).Assignment((JSAst).Variable(name), expr);
      }), (function () {
        return (JSAst).Variable(name);
      }));
    })).call(this);
  ...
  forStatement: (function () {
    return (this).memoize("unnamed_KVzJ/tjlgZIxT70W1UJfbw", (function () {
      var initExpr, condExpr, incExpr, stmt;
      return (this)._choice((function () {
  ...
  identifier: (function () {
    return (this).memoize("unnamed_U11P1tnXfhoZl05dpw1y5w", (function () {
      var name;
      return ((function () {
        (name = (this).stringPatternHandler("identifier"));
        (this)._predicate((function () {
          return !(((this).ReservedWords).include((id).text));
        }));
        return (id).text;
      })).call(this);
    }));
  ...
  identifierName: (function () {
    return (this).memoize("unnamed_Gl7Gv6bnqz+gxrqamxTcfQ", (function () {
      var name;
      return ((function () {
        (name = (this).stringPatternHandler("identifierName"));
        return (id).text;
      })).call(this);
    }));
  }),
