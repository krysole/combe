...
var JSLexer = ((module).exports = (Class).new(TextParser, {}, {
  nextToken: (function () {
    return (this).memoize("unnamed_b48JuFBYeri+yHMAXMMeSQ", (function () {
      return ((function () {
  ...
  string: (function () {
    return (this).memoize("unnamed_7h1qxGrKvCxSsM31z2C9GA", (function () {
      var text;
      return ((function () {
        (text = (this)._choice((function () {
        ...
        return ((this).createToken).call(this, "string");
      })).call(this);
    }));
  }),
  ...
  createToken: (function (type, value) {
    ...
    var token = (Token).new(type, value, text, ((this).state).tokenPosition, ((this).state).precededByNewline, (this).input);
