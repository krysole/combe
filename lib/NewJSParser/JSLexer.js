...
var JSLexer = module.exports = Class.new(TextParser, {
  ...
  identifier: (function () {
    return this.memoize("KXqr1YehygvJXMYGbX2GEQ", (function () {
      var text, token;
      return (function () {
        (function () {
          this.firstIdChar();
  ...
  punctuation: (function () {
    return this.memoize("7ARLgqXQ+Q3TPeyedBPRFg", (function () {
      var text;
      return (function () {
  ...
  operatorAssignment: (function () {
    return this.memoize("hHwaY6LHoer3005v6mHHTA", (function () {
      var text, t;
      return (function () {
        (function () {
          text = this._choice((function () {
          ...
          return (t.operatorAssignment = true, t.opname = text.slice(0, -1));
        }).call(this);
        return t;
      }).call(this);
    }));
  ...
  division: (function () {
    return this.memoize("NHDfJSBWwfde+rWacqARdA", (function () {
      var t;
  ...
  stringChar: (function () {
    return this.memoize("5VdgJPWgBdWy8GnfQMbAtA", (function () {
      return this._choice((function () {
        this.stringPatternHandler("\\");
  ...
  stringEscapeSequence: (function () {
    return this.memoize("rDdh93Q3Ruy2cNjk5V91aQ", (function () {
      var hs;
      return this._choice((function () {
        this.stringPatternHandler("'");
        return "'";
        ...
        (function () {
          ...
          return hs = this.repeat(this.hexDigit, 2);
        }).call(this);
        return String.fromCodepoint(hs.join(""));
      }), (function () {
        (function () {
          this.stringPatternHandler("u");
          return hs = this.repeat(this.hexDigit, 4);
        }).call(this);
        return String.fromCodepoint(hs.join(""));
      }), (function () {
        this._not((function () {
  ...
  regex: (function () {
    return this.memoize("sBmBvR2Uep6jMjxoPOZ8/g", (function () {
      var pattern, options;
      return (function () {
        this.stringPatternHandler("/");
