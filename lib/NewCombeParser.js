...
var NewCombeParser = module.exports = Class.new(BaseParser, {
  parseProgram: (function (string, filename) {
    return this.parse(string, filename, "program");
  }),
  parseExpression: (function (string, filename) {
    return this.parse(string, filename, "expression");
  }),
  parseStatement: (function (string, filename) {
    return this.parse(string, filename, "statement");
  }),
  parseSourceElement: (function (string, filename) {
    return this.parse(string, filename, "sourceElement");
  }),
  parse: (function (string, filename, rulename) {
    ...
    if (!result) {
      var t = parser.futhestToken;
      var lc = source.lineColumnAt(t.position);
      throw Error.new((((((("NewCombe Parser Failed: Furthest token was [" + t.text) + "] ") + filename) + ":") + lc[0]) + ":") + lc[1]);
    }
    return result;
  })
}, {
  ...
  functionDeclaration: (function () {
    return this.memoize("IUDq92y4XcamRJ0otetgmA", (function () {
      var name, args, stmts;
      return (function () {
        this.id("function");
  ...
  functionExpression: (function () {
    return this.memoize("ikXSJGG5GpWKaKNw6OraIA", (function () {
      var name, args, stmts;
      return (function () {
        this.id("function");
  ...
  ruleExpression: (function () {
    return this.memoize("PTppc1ovbZ0c5delDPRlsA", (function () {
      var name, args, p;
      return (function () {
        this.id("rule");
        name = this._optional(this.variableIdentifier);
  ...
  forInStatement: (function () {
    return this.memoize("44usDbTMaGdGL8xqxn4gdw", (function () {
  ...
  breakStatement: (function () {
    return this.memoize("NUQP/N0c43ZNHVsriSdXxQ", (function () {
      var t, name;
      return (function () {
        t = this.id("break");
        this._choice((function () {
  ...
  breakStatement: (function () {
    return this.memoize("gNB1RUGcyTrWN6jHwaeGOw", (function () {
      var t, name;
      return (function () {
        t = this.id("continue");
        this._choice((function () {
  ...
  logicalOrExpression: (function (noInFlag) {
    return this.leftAssociative((function () {
      return this.stringPatternHandler("||");
    }), this.logicalAndExpression, noInFlag);
  }),
  logicalAndExpression: (function (noInFlag) {
    return this.leftAssociative((function () {
      return this.stringPatternHandler("&&");
    }), this.bitwiseOrExpression, noInFlag);
  }),
  bitwiseOrExpression: (function (noInFlag) {
    return this.leftAssociative((function () {
      return this.stringPatternHandler("|");
    }), this.bitwiseXorExpression, noInFlag);
  }),
  bitwiseXorExpression: (function (noInFlag) {
    return this.leftAssociative((function () {
      return this.stringPatternHandler("^");
    }), this.bitwiseAndExpression, noInFlag);
  }),
  bitwiseAndExpression: (function (noInFlag) {
    return this.leftAssociative((function () {
      return this.stringPatternHandler("&");
    }), this.equalityExpression, noInFlag);
  }),
  equalityExpression: (function (noInFlag) {
    ...
    }), this.relationalExpression, noInFlag);
  }),
  ...
  shiftExpression: (function () {
    return this.memoize("ZJJEAYw25C+04wXMhZFkCQ", (function () {
      return this.leftAssociative((function () {
        return this._choice((function () {
          return this.stringPatternHandler("<<");
        }), (function () {
  ...
  additiveExpression: (function () {
    return this.memoize("1nnuQhy3fnMaEOIR/7byrw", (function () {
      return this.leftAssociative((function () {
        return this._choice((function () {
          return this.stringPatternHandler("+");
        }), (function () {
      ...
      }), this.multiplicitiveExpression);
    }));
  }),
  multiplicitiveExpression: (function () {
    return this.memoize("2y98DJFgsDyVi7o+J4hT5A", (function () {
      return this.leftAssociative((function () {
        return this._choice((function () {
          return this.stringPatternHandler("*");
  ...
  prefixExpression: (function () {
    return this.memoize("5wF631wIlQQLb11UB8BF+Q", (function () {
      var expr, op;
      return this._choice((function () {
        this.id("delete");
        expr = this.prefixExpression();
  ...
  postfixExpression: (function () {
    return this.memoize("FJEE40PrrVEd9qTVJqvMOQ", (function () {
      var expr, t;
      return (function () {
  ...
  leftHandSideExpression: (function () {
    return this.memoize("fRL9sgQRz4/xpgPdIfNmfA", (function () {
      return this._choice(this.memberExpression, this.callExpression);
    }));
  }),
  secondaryExpression: (function () {
    return this.memoize("oBLjjZDtKxdZsBLa4m3ZeA", (function () {
      var expr, ctor, args;
      return (function () {
        expr = this._choice((function () {
          this.id("new");
          ctor = this.secondaryExpression();
        ...
        this._repeat((function () {
          return expr = this.affixExpression(expr);
        }));
        return expr;
      }).call(this);
    }));
  }),
  affixExpression: (function (subject) {
    var args, name, expr;
    return this._choice((function () {
      args = this.arguments();
  ...
  returnPattern: (function () {
    return this.memoize("uPjiFCn/DJzyaHRlSIoj1Q", (function () {
      var p, expr, body;
      return this._choice((function () {
  ...
  immediatePattern: (function () {
    return this.memoize("p3He7BJ3iMVHySWFi2S+jQ", (function () {
      var expr, body;
      return this._choice((function () {
        this.stringPatternHandler("%");
        this._not(this.ws);
  ...
  t: (function (typename) {
    var token = this.next();
    if (token.is(typename)) {
      this.updateFurthestToken(token);
      return token;
    }
    else {
      this.fail();
  ...
  tokenAt: (function (position) {
    ...
    if (position >= this.tokens.length) {
      assert(this.tokens.isEmpty() || !this.tokens.last.is("eof"));
  ...
  ws: (function () {
    if (this.position === 0) {
      ...
      var lastToken = this.tokenAt(this.state.position - 1);
      var currentToken = this.peekNext();
      if ((lastToken.position + lastToken.length) < currentToken.position) {
        return;
      }
      else {
        this.fail();
  ...
  updateFurthestToken: (function (token) {
    if ((this.furthestToken.position <= token.position) && (this.furthestToken !== token)) {
      this.furthestToken = token;
    }
  })
});
