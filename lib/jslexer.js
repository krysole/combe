  ...
  var JSLexer = (__combejs__Class).create(TextParser, {
        ...
        return (this)._concat((function () {
          ...
          return (this)._choice((this).identifierName, (this).number, (this).assignmentOperator, (this).punctuation, (this).string, (function () {
            ...
            return (this)._concat((this).eof, (function () {
              return (this)._apply((this).token, "eof");
            }));
          }), (function () {
    ...
    identifierName: {
      value: (function () {
        var text;
        return (this)._concat((function () {
          return (text = (this)._apply((this).matchedInput, (function () {
      ...
      value: (function () {
        ...
        return (this)._concat((function () {
          return (this)._concat((function () {
            ...
            return (t = (this)._apply((this).token, text, [
              "punctuation",
              "assignmentOperator"
            ]));
          }), (function () {
    ...
    integerPart: {
      value: (function () {
        return (this)._choice("0", (function () {
          return (this)._concat((function () {
    ...
    exponentPart: {
      value: (function () {
        return (this)._concat((function () {
          return (this)._choice("e", "E");
        }), (function () {
          return (this)._choice("+", "-", (this).nothing);
        }), (function () {
          return (this)._repeat1((this).digit);
        }));
      }),
        ...
        return (this)._choice((function () {
          ...
          return (this)._concat((function () {
            return (this)._concat("x", (function () {
              return (hs = (this)._apply((this).repeat, (this).hexDigit, 2));
            }));
          }), (function () {
          ...
          return (this)._concat((function () {
            return (this)._concat("u", (function () {
              return (hs = (this)._apply((this).repeat, (this).hexDigit, 4));
            }));
          }), (function () {
            return (String).fromCodepoint((hs).join(""));
          }));
    ...
    regex: {
      value: (function () {
        var pattern, options;
        return (this)._concat("/", (function () {
          return (pattern = (this)._apply((this).matchedInput, (function () {
            return (this)._concat((function () {
              return (this)._concat((function () {
                return (this)._not("*");
              }), (this).regexChar);
          ...
          return (options = (this)._apply((this).matchedInput, (function () {
            return (this)._repeat((this).idChar);
          })));
        }), (function () {
